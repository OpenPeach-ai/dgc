...
STATIC_MEMBERS = {
    ...
    "extension/media/agents/agent-01-seafoam.svg": "media/agents/agent-01-seafoam.svg",
    "extension/media/agents/agent-01-seafoam-animated.svg": "media/agents/agent-01-seafoam-animated.svg",
    "extension/media/agents/agent-02-lagoon.svg": "media/agents/agent-02-lagoon.svg",
    "extension/media/agents/agent-02-lagoon-animated.svg": "media/agents/agent-02-lagoon-animated.svg",
    "extension/media/agents/agent-03-coral.svg": "media/agents/agent-03-coral.svg",
    "extension/media/agents/agent-03-coral-animated.svg": "media/agents/agent-03-coral-animated.svg",
    "extension/media/agents/agent-04-violet.svg": "media/agents/agent-04-violet.svg",
    "extension/media/agents/agent-04-violet-animated.svg": "media/agents/agent-04-violet-animated.svg",
    "extension/media/agents/agent-05-amber.svg": "media/agents/agent-05-amber.svg",
    "extension/media/agents/agent-05-amber-animated.svg": "media/agents/agent-05-amber-animated.svg",
    "extension/media/agents/agent-06-slate.svg": "media/agents/agent-06-slate.svg",
    "extension/media/agents/agent-06-slate-animated.svg": "media/agents/agent-06-slate-animated.svg",
    "extension/media/agents/agent-07-lime.svg": "media/agents/agent-07-lime.svg",
    "extension/media/agents/agent-07-lime-animated.svg": "media/agents/agent-07-lime-animated.svg",
    "extension/media/agents/agent-08-rose.svg": "media/agents/agent-08-rose.svg",
    ...
    "extension/licenses/LUCIDE-ISC.txt": "licenses/LUCIDE-ISC.txt",
}
GENERATED_MEMBERS = {
    "[Content_Types].xml",
