...
HOME and speaks editor protocol v14. Version 0.6.3 pairs with DGC CLI 0.43.2. Node 22 or newer.

The package is attached to the GitHub release `sdk-v0.6.3` as `vibedgc-sdk-0.6.3.tgz`. It is not
...
The SDK needs a DGC CLI (0.43.2 or newer). It uses `DGC_PYTHON` when set, else the installed
...
Full reference: [docs/SDK.md](https://github.com/OpenPeach-ai/dgc/blob/sdk-v0.6.3/docs/SDK.md).
