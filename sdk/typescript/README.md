...
HOME and speaks editor protocol v14. Version 0.6.6 pairs with DGC CLI 0.43.4. Node 22 or newer.

The package is on the npm registry. The identical tarball is also attached to the GitHub release
`sdk-v0.6.6` as `vibedgc-sdk-0.6.6.tgz`, for installs that pin a checksum.
...
Full reference: [docs/SDK.md](https://github.com/OpenPeach-ai/dgc/blob/sdk-v0.6.6/docs/SDK.md).
