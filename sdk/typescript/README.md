...
HOME and speaks editor protocol v14. Version 0.6.8 pairs with DGC CLI 0.44.1. Node 22 or newer.
...
The SDK needs a DGC CLI (0.44.1 or newer). It uses `DGC_PYTHON` when set, else the installed
