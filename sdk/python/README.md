...
protocol v14, pairs with DGC CLI **0.44.1**. Python 3.10+, proven on Linux.
...
and see the security model in [docs/SDK.md](https://github.com/OpenPeach-ai/dgc/blob/sdk-v0.6.8/docs/SDK.md#security-model).

- Guide and full API reference: [docs/SDK.md](https://github.com/OpenPeach-ai/dgc/blob/sdk-v0.6.8/docs/SDK.md)
- Runnable examples: [examples/sdk](https://github.com/OpenPeach-ai/dgc/tree/sdk-v0.6.8/examples/sdk)
- Changes: [sdk/CHANGELOG.md](https://github.com/OpenPeach-ai/dgc/blob/sdk-v0.6.8/sdk/CHANGELOG.md)
- Verifying this package against its GitHub release: [docs/SDK.md#verifying-a-release](https://github.com/OpenPeach-ai/dgc/blob/sdk-v0.6.8/docs/SDK.md#verifying-a-release)
