...
both for the current feature set: CLI 0.40.3 and extension 0.25.3 use editor protocol v14 (CLI 0.39.0
...
its extension. Extension 0.25.3 records its minimum CLI version, 0.40.3. If the connected CLI is too
