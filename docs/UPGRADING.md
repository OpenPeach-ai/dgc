...
both for the current feature set: CLI 0.39.0 and extension 0.24.0 use editor protocol v13. Additive
...
`the extension speaks editor protocol v12; this CLI speaks v13` means an older extension is running
