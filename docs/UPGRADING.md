...
both for the current feature set: CLI 0.41.1 and extension 0.26.0 use editor protocol v14 (CLI 0.39.0
...
its extension. Extension 0.26.0 records its minimum CLI version, 0.41.0. If the connected CLI is too
