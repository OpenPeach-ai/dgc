...
The complete offline evidence is 841/841 Python checks, 19/19 editor transport/webview checks, and
...
evidence is 841/841 Python checks, 19/19 editor transport/webview checks, and 1/1 installed-VS-Code
host smoke.
