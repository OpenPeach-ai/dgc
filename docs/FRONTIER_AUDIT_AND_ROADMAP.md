...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 769 / 769 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
The complete offline evidence is 769/769 Python checks, 18/18 editor transport/webview checks, and
...
evidence is 769/769 Python checks, 18/18 editor transport/webview checks, and 1/1 installed-VS-Code
host smoke.
