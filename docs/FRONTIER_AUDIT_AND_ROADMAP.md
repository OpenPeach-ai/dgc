...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 990 / 990 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
evidence is 990/990 Python checks, 20/20 editor transport/webview checks, and 1/1 installed-VS-Code
host smoke.
