...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 721 / 721 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
The complete offline evidence is 721/721 Python checks, 18/18 editor transport/webview checks, and
...
721/721 Python checks, 18/18 editor transport/webview checks, and 1/1 installed-VS-Code host smoke.
