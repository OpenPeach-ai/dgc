...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 966 / 966 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
evidence is 966/966 Python checks, 19/19 editor transport/webview checks, and 1/1 installed-VS-Code
host smoke.
