...
The complete offline evidence is 619/619 Python checks, 18/18 editor transport/webview checks, and
...
619/619 Python checks, 18/18 editor transport/webview checks, and 1/1 installed-VS-Code host smoke.
