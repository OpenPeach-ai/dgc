...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 1006 / 1006 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
| Extension tests | 2 / 2 | 19 / 19 + host 1 / 1 | jsdom protocol/render/safety/accessibility, real spawned-child transport/backpressure/decision-race flows, and activation/command registration/webview handshake plus permission/plan lifecycles inside installed VS Code are green. |
...
evidence is 1006/1006 Python checks, 20/20 editor transport/webview checks, and 1/1 installed-VS-Code
host smoke.
