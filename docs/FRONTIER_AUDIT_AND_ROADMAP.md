...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 619 / 619 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
The complete offline evidence is 619/619 Python checks, 17/17 editor transport/webview checks, and
...
619/619 Python checks, 17/17 editor transport/webview checks, and 1/1 installed-VS-Code host smoke.
