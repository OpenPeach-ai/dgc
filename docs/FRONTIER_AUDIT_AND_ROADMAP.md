...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 996 / 996 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
checks bounded command/event NDJSON with line-correlated, non-reflective diagnostics. This is a
stable conformance seam for clients and independent feature matrices; a published convenience client
SDK remains ecosystem work rather than being claimed by schema availability alone.
...
compatible. Wider external conformance and a published convenience client SDK remain open.
...
evidence is 996/996 Python checks, 20/20 editor transport/webview checks, and 1/1 installed-VS-Code
host smoke.
