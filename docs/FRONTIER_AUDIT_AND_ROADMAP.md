...
| Prove VS Code/Cursor implementation | Editor tests: **21/21**; TypeScript check and development bundle pass; the prior production bundle and installed VS Code host smoke pass activation plus 13 commands, handshake, live multi-root, SecretStorage, permission, and plan lifecycles | Automated local evidence complete; manual/cross-platform evidence remains |
...
| Extension tests | 2 / 2 | 21 / 21 + host 1 / 1 | jsdom protocol/render/safety/accessibility, real spawned-child transport/backpressure/decision-race flows, and activation/command registration/webview handshake plus permission/plan lifecycles inside installed VS Code are green. |
