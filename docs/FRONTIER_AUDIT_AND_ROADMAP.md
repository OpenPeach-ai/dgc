...
The complete offline evidence is 497/497 Python checks, 12/12 editor transport/webview checks, and
...
497/497 Python checks, 12/12 editor transport/webview checks, and 1/1 installed-VS-Code host smoke.
