...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 847 / 847 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
The complete offline evidence is 847/847 Python checks, 19/19 editor transport/webview checks, and
...
evidence is 847/847 Python checks, 19/19 editor transport/webview checks, and 1/1 installed-VS-Code
host smoke.
