...
|---|---:|---:|---|
| Python test harness | 225 / 226 | 1008 / 1008 | Environment-independent unit, adversarial, interaction-contract, provider, protocol, benchmark-control and mock-model E2E coverage. |
...
| Extension tests | 2 / 2 | 20 / 20 + host 1 / 1 | jsdom protocol/render/safety/accessibility, real spawned-child transport/backpressure/decision-race flows, and activation/command registration/webview handshake plus permission/plan lifecycles inside installed VS Code are green. |
