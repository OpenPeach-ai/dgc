...
- **Changed files** — the composer rail reviews workspace Git changes against the last commit, including files that predate this conversation. Native editor diffs, additions/deletions, new files and explicit partial-scan notices make its scope visible.
