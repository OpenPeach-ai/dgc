...
Current release: **dgc-sdk 0.6.3** on [PyPI](https://pypi.org/project/dgc-sdk/) and the Node
package `@vibedgc/sdk` 0.6.3, both tagged [`sdk-v0.6.3`](https://github.com/OpenPeach-ai/dgc/releases/tag/sdk-v0.6.3)
(not `v0.5.x`, which are historical CLI tags). They pair with CLI **0.43.2** over editor protocol
v14 and are proven on Linux. The full guide and API reference is
[docs/SDK.md](https://github.com/OpenPeach-ai/dgc/blob/sdk-v0.6.3/docs/SDK.md).
