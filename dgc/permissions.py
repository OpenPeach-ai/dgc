...
DISPLAY = {
    ...
    "apply_patch": "ApplyPatch", "repo_map": "RepoMap",
...
RULE_ARG = {
    ...
    "glob": "pattern", "grep": "pattern", "repo_map": "path",
...
READ_ONLY_TOOLS = {"read_file", "glob", "grep", "repo_map", "web_fetch", "web_search", "todo", "skill",
