...
EVENT_FIELDS: dict[str, dict[str, dict]] = {
    ...
    "model_changed": {"model": _S(), "base_url": _S()},
    "mode_changed": {
        "mode": _f("string", enum=("default", "acceptEdits", "plan", "auto")),
        "workspace_trusted": _B(False),
    },
    "think_changed": {"think": _f("string", enum=("off", "low", "medium", "high"))},
    "models": {
    ...
    "workspace_roots": {"roots": _A()},
    "saved_plan": {"plan": _S(), "exists": _B()},
    "session": {
...
COMMAND_FIELDS: dict[str, dict[str, dict]] = {
    ...
    "set_mode": {
        "mode": _f("string", enum=("default", "acceptEdits", "plan", "auto")),
        "acknowledge_workspace_trust": _B(False),
    },
    "set_model": {
    ...
    "new_session": {},
    "clear_session": {},
    "resume_session": {"path": _NS(False), "latest": _B(False)},
    "list_sessions": {},
