...
DGC can read files, modify a workspace, make network requests, and run commands when its active permissions allow. You are responsible for selecting an appropriate permission mode, reviewing approvals and diffs, protecting credentials, maintaining backups, and confirming generated changes before using them in production or another sensitive environment.

`auto` mode deliberately approves model-requested actions. Use it only in a trusted workspace and with a model and provider you trust. OS sandboxing is defense in depth, not a guarantee that generated code or commands are correct or safe.
...
The site, documentation, benchmarks, downloads, and software may change, be corrected, or become temporarily unavailable. Versioned release notes and checksums are provided to help you identify what you installed. Benchmark results describe the disclosed model, task set, settings, and scoring protocol; they are not a promise of performance on your code.

Third-party names and links are provided for compatibility, attribution, or convenience. Their inclusion does not imply sponsorship or endorsement.

## Disclaimers and liability

To the extent allowed by law, the site and software are provided as is, without warranties or conditions. To the extent allowed by law, Mohit Kalra, as operator of the DGC project, will not be liable for damages arising from use of the site, the software, generated changes, connected services, or inability to use them. Nothing here excludes a right or liability that applicable law does not allow to be excluded.
